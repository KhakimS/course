const employees = [
    ...
    {id: 3, name: 'Khakim Smagul', age:20, department: 'Finance', salary: 60000, specialization: 'Java'},   
];
...
function findEmployeeBySpecialization(employeeSpecialization){
    ...
    if (foundEmployee){
        ...
        document.getElementById('employeesDetails').innerHTML = `<p>No matches found</p>`;
    }
}